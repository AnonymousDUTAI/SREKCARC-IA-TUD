...
**2.科创比赛（Z，针对AI，占比10%）**
  ...
  这里主要来讲一下所谓的综合素质和能力测评成绩（Z，占比10%），学科竞赛与科研论文（H）、国际化素养（G）、专业素养（Y）、 参军退伍（C）等4部分，满分100分，即： **Z =min{H+G+Y+C,100}**，多一分相当于多0.1分综合成绩。
...
**3. 专业素养得分（Y，占比3%，也就是最高➕3分）**
  ...
  **3-2.指定科创比赛(最高加2分)**
  ...
  一些想法：其实就是下滑了PPT大赛的标准，将互联网+、挑战杯的获奖降到了省级一等奖，建议抱大腿，这个抱大腿会相对容易很多。
...
| B类 | 2    | 中国人工智能创新大赛 | 国赛一等奖（金奖） | 3     |
| B类 | 3    | 华为昇腾AI创新大赛 | 国赛一等奖（金奖） | 3     |
